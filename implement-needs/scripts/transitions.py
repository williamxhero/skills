...
THREAD_TRANSITIONS={"created":{"route_verified","archived"},"route_verified":{"assigned","archived"},"assigned":{"working","archived"},"working":{"handoff_received","archived"},"handoff_received":{"verified"},"verified":{"archived"},"archived":set()}
