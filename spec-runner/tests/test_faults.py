...
class FaultMatrixTests(unittest.TestCase):
    def test_public_cli_fault_matrix_is_replayable_and_separates_live_gaps(self):
        ...
        self.assertEqual([case["id"] for case in report["cases"]], ["normal_two_stage", "takeover_enters_normal_loop", "repeated_takeover_is_idempotent", "completed_drive_is_idempotent", "input_drift_rejected", "completed_cancel_does_not_reopen"])
